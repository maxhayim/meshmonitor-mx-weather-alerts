...
A) Timer Trigger / Timed Event (automatic alerts)
   - If there is no inbound message context, the script assumes TIMER mode.
   - It fetches active NWS alerts for WX_LAT/WX_LON
   - Dedupes against WX_STATE_PATH
...
MeshMonitor requirements:
- Script located in /data/scripts/
- Output JSON with "response" or "responses"
- Complete quickly
"""
